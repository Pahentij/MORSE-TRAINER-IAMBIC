...
v41 є поточною зафіксованою робочою базою проєкту.

Усі подальші зміни рекомендується виконувати від цієї версії зі збереженням перевіреної функціональності.
