...
v41 является текущей зафиксированной рабочей базой проекта.

Все последующие изменения рекомендуется выполнять от этой версии с сохранением проверенной функциональности.
